...
class knn:
    ...
    def plot_cross_validation(self):
        ...
        for n in range(1, self.num_of_classes + 1):
            ...
            scores = cross_val_score(knn, self.x_train, self.y_train, cv=k_fold_values[self.dataset],
                                     scoring='accuracy')
        ...
        # pg.plot(
        #     np.arange(1, self.num_of_classes + 1),
        #     class_scores,
        #     'Number of Neighbors',
        #     'Mean Accuracy Score',
        #     'KNN - neighbors vs accuracy - dataset : ' + self.dataset,
        #     'linear'
        # )
    ...
    def checkValidation(self):
        ...
        return metrics.accuracy_score(self.y_test, self.result)
...
def test_knn(dataset):
    ...
    for train_percent in train_percentage:
        ...
        accuracy_values.append(learn_knn.checkValidation())
