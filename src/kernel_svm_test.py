...
def test(dataset):
    ...
    kernels_by_dataset = {
        'breast_cancer': kernel_svm.linear_kernel,
        'digits': kernel_svm.linear_kernel,
        'forest_mapping': kernel_svm.gauss_kernel
    }
    ...
    # kernel we are using
    kernel = kernels_by_dataset[dataset]
    ...
    for train_percent in train_percentage:
        ...
        #     '<<CUSTOM SVM>> - C values vs accuracy - dataset : ' + dataset,
        #     'log'
        # )
    ...
    #     'Accuracy - Test Set',
    #     '<<CUSTOM>> SVM - Accuracy on Test Set - dataset : ' + dataset,
    #     'linear'
    # )
